...
// Use native fetch for better compatibility with development/sandbox SSL certificates
// expo/fetch can have issues with self-signed or development certificates
 ...
 *
 * The backend URL can be set via environment variables:
 * - EXPO_PUBLIC_BACKEND_URL: Production/custom environment
 * 
 ...
 * See PRODUCTION_INSTRUCTIONS.md for details.
 */
...
const fetchFn = async <T>(path: string, options: FetchOptions): Promise<T> => {
  ...
  try {
    ...
    // Handle TLS/SSL certificate errors specifically
    if (__DEV__ && error.message && error.message.includes('TLS error')) {
      console.error('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
      console.error('⚠️  SSL CERTIFICATE ERROR');
      console.error('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
      console.error('Backend URL:', BACKEND_URL);
      console.error('');
      console.error('This is a known issue with development SSL certificates.');
      console.error('The SSL certificate hostname does not match the domain.');
      console.error('');
      console.error('To fix this:');
      console.error('  1. Verify BACKEND_URL is correct in your .env file');
      console.error('  2. Check that your backend server is running');
      console.error('  3. For local development, use http:// (not https://)');
      console.error('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
    }
